  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <li class="nav-item">
		<div class="col-4">
			...
			<a href="logout.php"><i class="fas fa-sign-in-alt"></i></a></button>
    </div>
	  </li>
      </ul>
    </nav>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $_SESSION['unm']; ?></a>
        </div>
      </div>
    ...
    <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="catagaris.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="subcatagories.php" class="nav-link">
                  <p>SUB-CATAGORIES</p>
                </a>
              </li>
            </ul> -->
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Matirials.php" class="nav-link">
		  ...
		  <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="contect_us.php" class="nav-link">
